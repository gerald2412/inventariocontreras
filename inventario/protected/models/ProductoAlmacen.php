...
class ProductoAlmacen extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, alamacen_id, producto_id, existencia', 'required'),
			array('id, alamacen_id, producto_id, existencia', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, alamacen_id, producto_id, existencia', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    ...
                    'almacen'=>array(self::BELONGS_TO, 'Almacen', 'alamcen_id'),
	...
	public function search()
	{
		...
		$criteria->compare('alamacen_id',$this->alamacen_id);
