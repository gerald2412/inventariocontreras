		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Inicio', 'url'=>array('/site/index')),
                                array('label'=>'Almacenes', 'url'=>array('/alamacenes/index'), 'visible'=>!Yii::app()->user->isGuest),
				...
				array('label'=>'Ajustes', 'url'=>array('/ajustes/index'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Consulta', 'url'=>array('/consulta/index'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Juego', 'url'=>array('/juego/index'), 'visible'=>!Yii::app()->user->isGuest),
                                
                                array('label'=>'Acerca', 'url'=>array('/site/page', 'view'=>'about')),
                            
                                array('label'=>'Registrarse', 'url'=>array('/site/register'), 'visible'=>Yii::app()->user->isGuest),
                                array('label'=>'Cambiar contraseña', 'url'=>array('/site/changue'), 'visible'=>!Yii::app()->user->isGuest),
